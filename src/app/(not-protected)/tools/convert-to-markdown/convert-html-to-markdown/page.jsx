...
const ACCEPTED_FILE_TYPES = ".html, .htm";
const API_ENDPOINT = "/tools/convert-html-to-markdown";
const FILE_HINT = "HTML or HTM files up to 20MB";
const ACTION_LABEL = "Convert to Markdown";

export default function ConvertHtmlToMarkdown() {
