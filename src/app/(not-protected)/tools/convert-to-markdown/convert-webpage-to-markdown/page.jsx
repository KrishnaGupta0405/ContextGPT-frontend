...
const API_ENDPOINT = "/tools/convert-webpage-to-markdown";
const INPUT_LABEL = "Webpage URL";
const INPUT_PLACEHOLDER = "https://example.com/article";
const INPUT_HINT = "Enter the full URL of any public webpage.";
const ACTION_LABEL = "Convert to Markdown";

export default function ConvertWebpageToMarkdown() {
