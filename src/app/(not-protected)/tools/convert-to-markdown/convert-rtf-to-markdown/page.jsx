...
const ACCEPTED_FILE_TYPES = ".rtf";
const API_ENDPOINT = "/tools/convert-rtf-to-markdown";
const FILE_HINT = "RTF files up to 20MB";
const ACTION_LABEL = "Convert to Markdown";

export default function ConvertRtfToMarkdown() {
