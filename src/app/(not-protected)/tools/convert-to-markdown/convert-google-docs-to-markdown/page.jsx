...
const API_ENDPOINT = "/tools/convert-google-docs-to-markdown";
const INPUT_LABEL = "Google Docs URL";
const INPUT_PLACEHOLDER = "https://docs.google.com/document/d/your-doc-id/edit";
const INPUT_HINT = "Make sure the document is set to 'Anyone with the link can view'.";
const ACTION_LABEL = "Convert to Markdown";

export default function ConvertGoogleDocsToMarkdown() {
  ...
  const handleConvert = async () => {
    if (!url.trim()) return toast.error("Please enter a Google Docs URL.");
    setLoading(true);
    try {
