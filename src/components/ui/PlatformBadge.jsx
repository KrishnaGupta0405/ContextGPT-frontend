/**
 * PlatformBadge — shows a small coloured logo pill for a given platformSource.
 *
 * Usage:
 *   <PlatformBadge platform="MESSENGER" />           → pill with icon + label
 *   <PlatformBadge platform="SLACK" iconOnly />      → icon only (for tight spaces)
 */
...
const PLATFORM_META = {
  ...
  ZENDESK: {
    ...
    ring: "ring-green-200",
    icon: (
      <svg fill="#03363D" role="img" viewBox="0 0 24 24" className="w-3 h-3" xmlns="http://www.w3.org/2000/svg">
  ...
  ZOHO_SALES_IQ: {
    ...
    icon: (
      <svg fill="#E42527" role="img" viewBox="0 0 24 24" className="w-3 h-3" xmlns="http://www.w3.org/2000/svg">
...
/* ── Component ─────────────────────────────────────────────────────────────── */
export function PlatformBadge({ platform, iconOnly = false, className }) {
